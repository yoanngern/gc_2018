...
<form action="" method="post" id="createcondition" name="createcondition" class="pp-admin" <?php do_action('pp_condition_create_form_tag'); ?>>
...
PPP_StatusEditUI::status_edit_ui( '', array( 'new' => true, 'attrib_type' => $attrib_type ) );
?>

<?php
do_action( 'pp_new_condition_ui' );
?>
